...
<section class="content-news-style1">
	<div class="container">
		<div class="content-news_box">			
			<h2 class="heading">									
				<?php 
					$white__title = rwmb_meta('prefix_news-1st_black_heading');
					$blue__title = rwmb_meta('prefix_news-1st_blue_heading');
					echo $blue__title;
					?> <span><?= $white__title; ?></span>
			</h2>
			<?php 
				$link = rwmb_meta('prefix_news-1st_link_button');
				$text = rwmb_meta('prefix_news-1st_text_button');
			?>
...
<section class="content-news-style2">
	<div class="container">
		<div class="content-news_box">					
			<h2 class="heading">									
				<?php 
					$white__title = rwmb_meta('prefix_news-2nd_black_heading');
					$blue__title = rwmb_meta('prefix_news-2nd_blue_heading');
					echo $blue__title;
					?> <span><?= $white__title; ?></span>
			</h2>
			<?php
	...
	<div class="container">
		<div class="content-news_box">		
			<div class="box__left">	
				<h2 class="heading">									
					<?php 
						$white__title = rwmb_meta('prefix_news-3rd_white_heading');
						$blue__title = rwmb_meta('prefix_news-3rd_blue_heading');
						echo $blue__title;
						?> <span><?= $white__title; ?></span>
				</h2>
				<div class="paragraph">
					<?php
						$text = rwmb_meta('prefix_news-3rd_text');
						echo $text;
					?>
				</div>

				<?php 
					$link = rwmb_meta('prefix_news-3rd_link_button');
					$text = rwmb_meta('prefix_news-3rd_text_button');
				?>
...
<section class="content-media">
	<div class="container">
		<div class="content-media_box">			
			<div class="box__ads">
				<?php 
					$ads = rwmb_meta('prefix_news-media_ads');
					if ( ! empty( $ads ) ): ?>
						<div class="ads__slider owl-carousel">
						<?php foreach ( $ads as $ads__item ):
							$image = isset( $ads__item['prefix_news-image'] ) ? $ads__item['prefix_news-image'] : '';
							$icon = wp_get_attachment_image_url( $image, 'full' );
							$link = $ads__item['prefix_news-link'];
							?>
			...
			<div class="box__media">			
				<h2 class="heading">									
					<?php 
						$white__title = rwmb_meta('prefix_news-media_heading_white');
						$blue__title = rwmb_meta('prefix_news-media_heading_blue');
						echo $white__title;
	...
	<div class="container">
		<div class="content-press_box">
			<div class="box__left">
				<h2 class="heading">									
					<?php 
						$white__title = rwmb_meta('prefix_news-registration_heading_white');
						$blue__title = rwmb_meta('prefix_news-registration_heading_blue');
						echo $white__title;
						?> <span><?= $blue__title; ?></span>
				</h2>
				...
				<div class="paragraph">								
					<?php 
						$text = rwmb_meta('prefix_news-registration_text');
						echo $text;
					?>
				</div>
			</div>
			...
			<div class="box__right">						
				<?php 
					$form = rwmb_meta('prefix_news-registration_form');
				?>
				<?= do_shortcode( $form ); ?>
			</div>
		</div>
