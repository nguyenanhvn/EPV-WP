...
// 'submenu' => false, // Setting submenu to false on a given section will hide it from the WordPress sidebar menu!
    'fields'    => array(     
        ...
        array(
            'id'        => 'top-head-des',
            'type'        => 'text',
            'title'     => __('Top Head Description', 'epv'),
        ),
        array(
        ...
        array(
            'id'        => 'top-head-des-vi',
            'type'        => 'text',
            'title'     => __('Top Head Description VI', 'epv'),
        ),
        array(
            'id'        => 'popup-image',
            'type'      => 'media',
...
$this->sections[] = array(
    ...
    'fields'    => array(                    
        array(
            ...
            'type'     => 'select',
            'data'     => 'posts',
            'args'     => array('post_type' => 'e-brochures','posts_per_page' => -1),
            'title'    => __('E-Brochures Select', 'epv'),
            'multi'    => true,
        ),  
        array(
            'id'       => 'ebrochure-post-vi',
            'type'     => 'select',
            'data'     => 'posts',
            'args'     => array('post_type' => 'e-brochures','posts_per_page' => -1),
            'title'    => __('E-Brochures VI Select', 'epv'),
            'multi'    => true,
        ),  
    ),
);
