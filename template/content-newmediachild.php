...
<section class="content-news-style1">
	<div class="container">
		<div class="content-news_box">
			...
			$urlAll = (pll_current_language() == 'en') ? site_url()."/new-media/industry-news/" : site_url()."/tin-tuc-truyen-thong/tin-nganh/";
			?>
			<a class="view__all" href="<?= $urlAll; ?>"><?= (pll_current_language() == 'en') ? 'View All Industry News' : 'Xem Tất Cả Tin Ngành'; ?></a>
