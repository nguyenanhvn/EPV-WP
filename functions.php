...
function default_menus() {
	...
	$locations = array(
		...
		'exhibit'   => __( 'Exhibit Menu', 'default' ),
		'visiting'   => __( 'Visiting Menu', 'default' ),
		'needtoknow'   => __( 'NeedToKnow Menu', 'default' ),
		'contact'   => __( 'Contact Menu', 'default' ),
		'newmedia'   => __( 'New Media Menu', 'default' ),
